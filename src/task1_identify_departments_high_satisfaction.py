...
def main():
    ...
    # Define file paths
    input_file = "/workspaces/spark-structured-api-employee-engagement-analysis-Krishna-coder12/input/employee_data.csv"
    output_file = "/workspaces/spark-structured-api-employee-engagement-analysis-Krishna-coder12/outputs/departments_high_satisfaction.csv"
